...
mv jobs/conqueror.js jobs.conqueror.js
mv jobs/defender.js jobs.defender.js
...
mv structures/spawn.js structures.spawn.js
mv structures/tower.js structures.tower.js